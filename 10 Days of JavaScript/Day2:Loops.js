...
// Task
// Complete the vowelsAndConsonants function in the editor below. It has 1. one parameter, a string, s, consisting of lowercase English alphabetic letters (i.e., a through z). The function must do the following:
...
const vowelsAndConsonants = (word) => {
    ...
    for (const character of word) {
     ...
     }else consonants.push(character);
    }
    console.log(vowelsArray.concat(consonants).join("\n"));
}
