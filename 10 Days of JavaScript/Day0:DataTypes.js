...
// On the second line, print the sum of firstDecimal and the floating-point representation of firstDecimal .
...
function performOperation(secondInteger, secondDecimal, secondString) {
    ...
    const first = parseFloat(firstDecimal.toFixed(2));
    const second = parseFloat(secondDecimal);
